...
const analysisStages = [
  ...
  { id: 'vision', label: 'Analyzing with Vision API...', icon: Eye },
  { id: 'gemini', label: 'Generating description with Gemini...', icon: Brain },
    ...
    const runAnalysis = async () => {
      try {
        ...
        updateReportData({
          ...
          issueType: visionResult.detectedIssueType,
          description: geminiResult.description,
        })
        setEditedDescription(geminiResult.description)
        setIsAnalyzing(false)
      } catch (error) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card hover={false} className="p-6">
        ...
        {/* Detected labels */}
        {reportData.analysisResult?.vision?.labels?.length > 0 && (
